## Slide 1: Monorepo Scaling Problems
...
Visual Idea: A "Tangled Yarn" diagram. A mess of red lines connecting scattered folders. Overlaid text: "Change in ui-button.css → 5 apps rebuilt"

## Slide 2: The NX Project Graph
...
Visual Idea: A glowing, neon-colored Directed Acyclic Graph (DAG) pulsing on a dark background. Text: "It's built in Rust"

## Slide 3: Task Inference and Plugins
...
## Slide 4: Task Pipelines and Executionon
...
## Slide 6: Enforcing Architectural Constraints
...
## Slide 7: Impact on Developer Workflow
